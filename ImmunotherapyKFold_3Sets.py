...
def main():
    ...
    df = pd.read_csv('data\Immunotherapy.csv', sep=';')
    df_ar = df.values
...
def evaluate(params, rules_f: List[Rule], lv, dataset, measures, decision, classify_func, y):
    f_params1 = {lv[0]: params[0], lv[1]: params[1], lv[2]: params[2],
                 ...
                 lv[6]: params[6]}
    f_params2 = {lv[0]: params[7], lv[1]: params[8], lv[2]: params[9],
                 lv[3]: params[10], lv[4]: params[11], lv[5]: params[12],
                 lv[6]: params[13]}
    print(params)
    rules_f[0].consequent.function_parameters = f_params1
    rules_f[1].consequent.function_parameters = f_params2
    rules_f[0].consequent.bias = params[14]
    rules_f[1].consequent.bias = params[15]
