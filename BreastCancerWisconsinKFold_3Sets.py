...
def main():
    ...
    for train_index, test_index in skf.split(train, train_y):
        ...
        mean_gausses_type2 = fuzzy_params.generate_3_t2_sets(["small", "medium", "large"], 0.0)
        ...
        parameters_1 = {ling_vars[0]: -1.5, ling_vars[1]: -2.0, ling_vars[2]: -3.5,
                        ...
                        ling_vars[6]: -2.0, ling_vars[7]: -3.5, ling_vars[8]: -5.5}
        ...
        xopt, fopt = pso(fitness, lb, ub, debug=True, maxiter=25, swarmsize=25)
