...
def main():
    ...
    for train_index, test_index in skf.split(train, train_y):
        ...
        mean_gausses_type2 = fuzzy_params.generate_7_t2_sets(["vsmall", "small", "smedium", "medium", "lmedium", "large", "vlarge"], 0.03)
        ...
        train_mean_gausses_type2 = fuzzy_params.generate_7_t2_sets(
            ["vsmall", "small", "smedium", "medium", "lmedium", "large", "vlarge"], 0.03)
